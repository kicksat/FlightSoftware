...
int uplink_to_command_num()
{
  if(strrchr(myBeacon.uplink_message, 1) != NULL)
  {
    return 1;
  }
  else if(strrchr(myBeacon.uplink_message, 2) != NULL)
  {
    return 2;
  }
  else if(strrchr(myBeacon.uplink_message, 3) != NULL)
  {
    return 3;
  }
  else if(strrchr(myBeacon.uplink_message, 4) != NULL)
  {
    return 4;
  }
  else if(strrchr(myBeacon.uplink_message, 5) != NULL)
  {
    return 5;
  }
  else if(strrchr(myBeacon.uplink_message, 6) != NULL)
  {
    return 6;
  }
  else if(strrchr(myBeacon.uplink_message, 7) != NULL)
  {
    return 7;
  }
  else if(strrchr(myBeacon.uplink_message, 8) != NULL)
  {
    return 8;
  }
  else if(strrchr(myBeacon.uplink_message, 0) != NULL)
  {
    return 0;
  }
  else
