...
// LEDs
#define PIN_LED_9			 (4u) //orig 13 instead of 4
#define PIN_LED_RXL          (25u)
#define PIN_LED_TXL          (26u)
#define PIN_LED              PIN_LED_4 //orig 13
#define PIN_LED2             PIN_LED_RXL
#define PIN_LED3             PIN_LED_TXL
#define LED_BUILTIN          PIN_LED_4 //orig 13
...
#define PIN_SPI_CS_SD		(6ul) //added instead of ATN above
#define PIN_SPI_CS_RFM		(25ul) //new
#define PIN_SPI_CS_XTB1		(27ul) //new
#define PIN_SPI_CS_XTB2		(30ul) //new
#define PIN_SPI_CS_XTB3		(11ul) //new
#define PIN_SPI_CS_XTB4		(12ul) //new
#define PIN_SPI_CS_MRAM		(31ul) //new
#define PIN_XTB_RESET		(26ul) //new
#define PIN_RF_NIRQ			(14ul) //new
#define PIN_RF_SDN			(42ul) //new
#define PIN_I_BATT			(17ul) //new
#define PIN_VBATT			(18ul) //new
#define PIN_L1_PROG			(8ul)  //new
#define PIN_ENAB_GPS		(9ul)  //new
#define PIN_ENAB_BURN1		(19ul) //new
#define PIN_ENAB_BURN2		(2ul)  //new
#define PIN_ENAB_BURN3		(3ul)  //new
#define PIN_ENAB_BURN4		(0ul)  //new
...
static const uint8_t SPI_CS_XTB3 = PIN_SPI_CS_XTB3; //new
static const uint8_t SPI_CS_XTB4 = PIN_SPI_CS_XTB4; //new
static const uint8_t SPI_CS_MRAM = PIN_SPI_CS_MRAM; //new
...
static const uint8_t ENAB_BURN5 = PIN_ENAB_BURN5; //new
...
#define PIN_SPI_MISO         (7u) //orig 12
#define PIN_SPI_MOSI         (20u) //orig 11
...
#define PAD_SPI_TX           SPI_PAD_0_SCK_1 //original pad 0, clk 1
#define PAD_SPI_RX           SERCOM_RX_PAD_3 //original pad 3
